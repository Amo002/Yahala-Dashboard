                                ...
                                <td>
                                    <div class="d-flex flex-wrap gap-2">
                                        @foreach ($role->permissions as $permission)
                                            <div
                                                class="d-flex align-items-center bg-info bg-opacity-10 rounded-pill px-3 py-1">
            ...
            <form method="POST" action="{{ route('admin.roles.store') }}" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Use lowercase with underscores (e.g. <code>user_editor</code>). Label will
                            be auto-formatted.</small>
                    </div>
                </div>
